          ...
          <div className="detail__product">
            <div className="detail__product--imgs">
              <div className="detail__product--imgs--ref">
                {images.map((item, index) => {
                  return (
                    <div
                      className="detail__product--imgs--ref--1"
                      key={index}
                      onClick={() => handleChangeImage(index)}
                    >
                      <img
                        className={
                          index === displayImage.position ? "active" : ""
                        }
                        src={item}
                        alt=""
                      />
              ...
              <div className="detail__product--imgs--main">
                <img src={images[displayImage.position]} alt="" />
                <div className="dots__imgs">
                  <i
                    className="fas fa-chevron-left"
                    onClick={() => handleChangePosImage(-1)}
                  ></i>
                  <i
            ...
            <div className="detail__product--info">
                ...
                {colors.map((item, index) => {
                  return (
                    <div
                      key={index}
                      className={
                        item === cartParams.color
                          ? "sizes--detail--item active"
                          : "sizes--detail--item"
                      }
                      onClick={() => handleColorCart(item)}
                    >
                      {item}
                    </div>
                  );
                ...
                {sizes.map((item, index) => {
                  return (
                    <div
                      ...
                      className={
                        item === cartParams.size
                          ? "detail__product--info--size--item sizes--detail--item active"
                          : "detail__product--info--size--item sizes--detail--item"
                      }
                      onClick={() => handleColorSize(item)}
                    >
                      {item}
                    </div>
                  );
              ...
              <div className="detail__product--info--qc">
                ...
                <div
                  className="detail__product--info--qc--cart"
            ...
            <div className="info__main">
              <div className="info__main--info">
                ...
                <div className="info__main--info--detail">
                  <div className="bold brief--info">{desc[1]}</div>
                  <div className="more--info">{desc[2]}</div>
